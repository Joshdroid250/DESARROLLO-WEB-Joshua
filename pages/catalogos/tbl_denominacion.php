...
<head>
  ...
  <title>dbkermesse | Tabla Denominacion</title>
            ...
            <div class="card">
              ...
              <h3 class="card-title">Denominacion</h3>
                ...
                <div  class="form-group col-md-12" style="text-align:right">
                    <a href="frm_denominacion.php" title="Nueva Denominacion" target="blank"><i class="far fa-plus-square"></i>Nueva Denominacion</a>
                    </div>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                  foreach($dtg-> listadenominacion() as $r):
                  ?>
                  ...
                  <tr>
                    ...
                    <td> <a href="frm_edit_denominacion.php?editG=<?php echo $r->__GET('id_Denominacion');?>" target="blank">
                    <i class="far fa-edit" title="Editar Denominacion"></i></a>
                    &nbsp;&nbsp;
                    <a href="frm_view_denominacion.php?viewG=<?php echo $r->__GET('id_Denominacion');?>" target="blank">
                    <i class="far fa-eye" title="Ver Denominacion"></i></a>
                    &nbsp;&nbsp;
