            ...
            <div class="card card-primary">
              ...
              <form>
                ...
                <div class="form-group">
                    ...
                    <input readonly value="<?php echo $lp->__GET('nombreKermesse'); ?>" type="text" class="form-control" id="id_kermesse" name="id_kermesse"placeholder="Nombre Kermesse">
                  </div>
                  <div class="form-group">
                    <label>nombre</label>
                    <input readonly value="<?php echo $lp->__GET('nombre'); ?>" type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre">
                  </div>
                  <div class="form-group">
                    <label>Descipcion</label>
                    <input readonly value="<?php echo $lp->__GET('descripcion'); ?>" type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Descripcion">
                  </div>
                </div>
                <!-- /.card-body -->
