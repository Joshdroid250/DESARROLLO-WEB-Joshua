  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> Item Parroquia</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Inicio</a></li>
              <li class="breadcrumb-item active">Lista Parroquia</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="direccion" name="direccion" placeholder="Escriba la direccion">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="sitio_web" name="sitio_web" placeholder="">
                  </div>
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-footer">
                  ...
                  <a href="tbl_parroquia.php"><i class="far fa fa-undo-alt"></i>Regresar</a>
