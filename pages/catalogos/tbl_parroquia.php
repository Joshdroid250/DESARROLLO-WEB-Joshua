...
<head>
  ...
  <title>dbkermesse | Tabla Parroquia</title>
              ...
              <h3 class="card-title">Parroquia</h3>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    &nbsp;&nbsp;
                    <a href="../../negocio/ng_Parroquia.php?delP=<?php echo $r->__GET('idParroquia') ?>"  target="blank" >
...
<script>function deleteParroquia(id)
        {
            confirm(function(e,btn)
            {
                e.preventDefault();
                window.location.href = "../../negocio/ng_parroquia.php?delP="+id;
            },
            function(e,btn)
            {
                e.preventDefault();      
