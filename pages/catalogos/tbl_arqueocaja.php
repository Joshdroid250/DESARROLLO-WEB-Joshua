...
<head>
  ...
  <title>dbkermesse | Tabla Arqueo Caja</title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title">Arqueo Caja</h3>
                </div>
                <div class="card-body">
                <div  class="form-group col-md-12" style="text-align:right">
                    <a href="frm_arqueocaja.php" title="Nuevo Arqueo de Caja" target="blank"><i class="far fa-plus-square"></i>Nuevo Arqueo de Caja</a>
                    </div>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                  foreach($dtg-> lista_arqueocaja() as $r):
                  ?>
                  ...
                  <tr>
                    ...
                    <td> <a href="frm_edit_arqueocaja.php?editG=<?php echo $r->__GET('id_ArqueoCaja');?>" target="blank">
                    <i class="far fa-edit" title="Editar Arqueo de Caja"></i></a>
                    &nbsp;&nbsp;
                    <a href="frm_view_arqueocaja.php?viewG=<?php echo $r->__GET('id_ArqueoCaja');?>" target="blank">
                    <i class="far fa-eye" title="Ver Arqueo de Caja"></i></a>
                    &nbsp;&nbsp;
