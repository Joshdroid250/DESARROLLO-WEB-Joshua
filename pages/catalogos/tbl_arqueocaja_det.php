...
<head>
  ...
  <title>dbkermesse | Tabla Arqueo Caja Det</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Arqueo Caja Det</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title">Arqueo Caja Det</h3>
                </div>
                <div class="card-body">
                <div  class="form-group col-md-12" style="text-align:right">
                    <a href="frm_arqueocaja_det.php" title="Nuevo Arqueo de Caja Det" target="blank"><i class="far fa-plus-square"></i>Nuevo Arqueo de Caja Det</a>
                    </div>
                <table id="example1" class="table table-bordered table-striped">
                  <thead>

                  <tr>
                    <th>ID Arqueo Caja Det</th>
                  ...
                  <?php
                  foreach($dtg-> lista_arqueocaja_det() as $r):
                  ?>
                  ...
                  <tr>
                    ...
                    <td> <a href="frm_edit_arqueocaja_det.php?editG=<?php echo $r->__GET('idArqueoCaja_Det');?>" target="blank">
                    <i class="far fa-edit" title="Editar Arqueo de Caja Det"></i></a>
                    &nbsp;&nbsp;
                    <a href="frm_view_arqueocaja_det.php?viewG=<?php echo $r->__GET('idArqueoCaja_Det');?>" target="blank">
                    <i class="far fa-eye" title="Ver Arqueo de Caja Det"></i></a>
                    &nbsp;&nbsp;
