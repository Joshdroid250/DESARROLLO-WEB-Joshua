        ...
        case '1':
            ...
            case '2':
                try {
                    ...
                    $dtUs->editUser($us);
                    header("Location: /Desarrollo-WEB-master/pages/catalogos/tbl_usuario.php?msj=3");
                } catch (Exception $e) {
                    header("Location: /Desarrollo-WEB-master/pages/catalogos/tbl_usuario.php?msj=4");
                    die($e->getMessage());
                }
                break;
